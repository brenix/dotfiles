...
--enable-features=brotli-encoding,LazyFrameLoading,FontCacheScaling,NoStatePrefetch,SpeculativeResourcePrefetching,SpeculativePreconnect,ProactiveTabFreezeAndDiscard,SimplifyHttpsIndicator,EnableTLS13EarlyData,NewStyleNotifications  \\
--enable-lcd-text \\
--enable-precache \\
--enable-quic \\

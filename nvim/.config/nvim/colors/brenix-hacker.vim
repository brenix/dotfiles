" -----------------------------------------------------------------------------
" Name:         Hacker
" Description:  Dark old-school hacker theme
" -----------------------------------------------------------------------------
...
let g:colors_name = 'brenix-hacker'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.transparent_background = get(g:, 'brenix_hacker_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'brenix_hacker_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'brenix_hacker_enable_italic', 0)
let s:configuration.current_word = get(g:, 'brenix_hacker_current_word', get(g:, 'brenix_hacker_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
      \ 'bg0':        ['#030303',   '235',  'Black'],
      \ 'bg1':        ['#111111',   '236',  'DarkGrey'],
      \ 'bg2':        ['#222222',   '237',  'DarkGrey'],
      \ 'bg3':        ['#333333',   '238',  'DarkGrey'],
      \ 'bg4':        ['#444444',   '239',  'Grey'],
      \ 'bg_red':     ['#392f32',   '52',   'DarkRed'],
      \ 'bg_green':   ['#152015',   '22',   'DarkGreen'],
      ...
      \ 'blue':       ['#81b38c',   '109',  'Blue'],
      \ 'purple':     ['#507057',   '175',  'Magenta'],
      \ 'grey':       ['#959595',   '245',  'LightGrey'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
" }}}
" Function: {{{

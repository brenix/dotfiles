if &background == 'dark'
  let s:guishade0 = "#0f1113"
  let s:guishade1 = "#2b2d2e"
  let s:guishade2 = "#46484a"
  let s:guishade3 = "#626465"
  let s:guishade4 = "#7d8081"
  let s:guishade5 = "#999c9c"
  let s:guishade6 = "#b4b7b8"
  let s:guishade7 = "#d0d3d3"
  let s:guiaccent0 = "#bb6b6b"
  let s:guiaccent1 = "#f2b494"
  let s:guiaccent2 = "#cfd189"
  let s:guiaccent3 = "#85ba87"
  let s:guiaccent4 = "#78baba"
  let s:guiaccent5 = "#719eba"
  let s:guiaccent6 = "#a59aba"
  let s:guiaccent7 = "#97aed0"

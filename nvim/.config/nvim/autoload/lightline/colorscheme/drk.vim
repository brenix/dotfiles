...
let s:darker    = [ '#0f1113', 235 ]
let s:darkgrey  = [ '#282d2d', 239 ]
let s:dark      = [ '#0f1113', 235 ]
let s:grey      = [ '#7e8080', 246 ]
let s:red       = [ '#bb6b6b', 167 ]
let s:green     = [ '#85ba87', 142 ]
let s:yellow    = [ '#cfd189', 208 ]
let s:blue      = [ '#87bcde', 208 ]
let s:white     = [ '#d0d3d3', 223 ]
"}}}
...
if get(g:, 'drk_lightline_disable_bold', 0)
...
let g:lightline#colorscheme#drk#palette = lightline#colorscheme#flatten(s:p)

...
alias ve='variant export'
alias vg='variant generate'
alias vr='variant run'
alias x='startx'
alias xrefresh='xrdb load ~/.Xresources && xrdb -merge ~/.Xresources'
[[ "$OSTYPE" == "darwin"*  ]] && alias u='brew update && brew upgrade && brew cleanup'
[[ "$OSTYPE" == "linux-gnu" ]] && alias u='yay -Syu'
(( $+commands[bat] )) && alias cat='bat --decorations never --paging never' && alias less='bat'
